...
import { GeoPoint, collection, getDocs } from "firebase/firestore/lite";
    ...
    <Layout>
      <Container>
        <div className="p-8 flex items-center justify-center">
          <TextField
            placeholder="Search..."
            inputProps={{ className: "px-2 py-1", ...register("search") }}
          />
        </div>
        <p className="text-2xl text-center mb-2">All Events</p>
        <Calendar
          ...
          events={events
            .filter(({ event_name }) =>
              event_name.toLowerCase().includes(search),
            )
